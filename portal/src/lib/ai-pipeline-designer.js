/**
 * AI pipeline designer - maps natural language intent to patterns (browser ESM).
 * Keep in sync with ../../../lib/ai-pipeline-designer.js
 */
...
export function matchPatternFromMessage(message) {
  let best = null;
  let bestScore = 0;
...
export function designPipelineFromMessage(message) {
