...
<p align="center">
  <img src="../../assets/portal-canvas-datamesh.png" alt="Kafka → Iceberg Stream - CogniMesh canvas" width="720" />
  <br /><em>Real-time event pipeline</em>
</p>
...
Stream events from Kafka through a passthrough or Spark transform into Iceberg.



| | |
|---|---|
| **Pattern ID** | `kafka-stream` |
| **Category** | Streaming |
| **Difficulty** | Advanced |
| **Architecture** | - |
...
Clickstream, IoT, or event bus data with low latency requirements.
...
**AWS services:** `MSK/Kafka` · `Glue` · `S3` · `Step Functions`
...
2. Paste: _"Kafka → Iceberg Stream - Real-time event pipeline"_
...
2. Filter: **Streaming**
3. Find **Kafka → Iceberg Stream** → **Use pattern**
