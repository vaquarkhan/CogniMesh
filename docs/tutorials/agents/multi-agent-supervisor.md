...
<p align="center">
  <img src="../../images/portal-agent-builder-canvas.png" alt="Multi-Agent Supervisor - Agent Builder canvas" width="720" />
  <br /><em>Router · specialist sub-agents</em>
</p>
...
Supervisor routes requests to specialist agents - research, writing, and tool execution - with shared guardrails.

| | |
|---|---|
| **Template ID** | `multi-agent-supervisor` |
| **Category** | Enterprise |
| **Framework** | crewai |
...
Complex workflows needing specialized sub-agents under one runtime.
...
**Features:** Guardrails, Gateway & tools, Code interpreter, Browser tool

**AWS services:** `AgentCore Runtime` · `Supervisor` · `Gateway` · `Guardrails`
...
2. Enable: Guardrails, Gateway & tools, Code interpreter, Browser tool
3. Paste: _"Multi-agent supervisor routing to browser and code sub-agents"_
...
- Supervisor picks specialist by capability tags.
- Shared guardrail applies to all sub-agent outputs.
