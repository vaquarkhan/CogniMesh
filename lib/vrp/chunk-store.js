...
/** Delete a local staging artifact after IceGuard rollback (best-effort). */
function deleteChunkArtifact(localPath) {
...
module.exports = { writeChunkRecords, readChunkRecords, stagingRoot, deleteChunkArtifact };
