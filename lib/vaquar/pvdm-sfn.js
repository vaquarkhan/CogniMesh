...
function compileVaquarStateMachine(contract, options = {}) {
  const lambdaArn =
    options.lambdaQualifiedArn ||
    process.env.VAQUAR_DOMAIN_WRITER_ARN ||
    "arn:aws:lambda:us-east-1:123456789012:function:cognimesh-domain-writer:live";
  ...
  const integrityGateFn =
    options.integrityGateFunctionName ||
    process.env.INTEGRITY_GATE_FUNCTION ||
    "cognimesh-integrity-gate";
