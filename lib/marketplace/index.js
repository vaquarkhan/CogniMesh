...
function marketplaceCatalog() {
  return {
    ...
    endpoints: [
      ...
      { method: "POST", path: "/api/v1/marketplace/products/:id/schema-diff", summary: "Diff schemas / contracts (breaking columns)" },
    ...
    honesty: [
      ...
      "Subscription tokens are HMAC stamps, not Cognito JWTs",
    ],
  };
}
