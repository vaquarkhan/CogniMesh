    ...
    if (!roleArn) {
      return {
        ...
        errors: [
          ...
          "Run prod Terraform with enable_platform_ops=true or set the role ARN manually",
        ],
      };
    }
...
module.exports = { deployAgentToAws, isAgentDeployEnabled, buildAgentResources, waitForAgentPrepared };
